...
<style type="text/css" src="./elegant-icon.css">
</style>
<style type="text/css" src="./font-awesome.min.css"></style>
<style type="text/css" src="./nice-select.css">
</style>
<style type="text/css" src="./owl.carousel.min.css">
</style>
<style type="text/css" src="./plyr.css">
</style>
<style type="text/css" src="./slicknav.min.css">
</style>
